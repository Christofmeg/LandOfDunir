...
public class FireGoblin extends Monster {
    private int remainingFireTicks = -this.getFireImmuneTicks();
    public FireGoblin(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    protected void dropCustomDeathLoot(DamageSource pSource, int pLooting, boolean pRecentlyHit) {
        ...
        ItemEntity itementity = this.spawnAtLocation(Items.MAGMA_CREAM);
        if (itementity != null) {
    ...
    public void setSecondsOnFire(int pSeconds) {
        ...
        if (this instanceof LivingEntity) {
            i = this.getFireAfterDampener((LivingEntity)this, i);
        }
    ...
    public boolean doHurtTarget(Entity pEntity) {
        if (!super.doHurtTarget(pEntity)) {
            ...
            if (pEntity instanceof LivingEntity) {
                ((LivingEntity)pEntity).setSecondsOnFire(20);
            }
