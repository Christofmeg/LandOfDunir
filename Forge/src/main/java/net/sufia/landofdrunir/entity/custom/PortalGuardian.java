...
public class PortalGuardian extends Monster {
    ...
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(PortalGuardian.class, EntityDataSerializers.BOOLEAN);
    ...
    public PortalGuardian(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1,new PortalGuardianAttackGoal(this,0.5, true));
    }
   ...
   @Override
    ...
    public boolean hurt(DamageSource source, float amount) {
        ...
        if (source.is(DamageTypes.TRIDENT))
            return false;
        this.playSound(SoundEvents.ANVIL_PLACE, 1.5F, 1.0F);
