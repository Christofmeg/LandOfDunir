...
public class GoblinMinor extends Monster{

    public GoblinMinor(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    protected void dropCustomDeathLoot(DamageSource pSource, int pLooting, boolean pRecentlyHit) {
        ...
        ItemEntity itementity = this.spawnAtLocation(Items.STRING);
        if (itementity != null) {
