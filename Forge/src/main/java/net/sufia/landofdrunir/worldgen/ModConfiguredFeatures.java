package net.sufia.landofdrunir.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        register(context, FIR_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                ...
                new FirTrunkPlacer(5, 4, 3),

                BlockStateProvider.simple(ModBlocks.FIR_LEAVES.get()),
                new FirFoliagePlacer(ConstantInt.of(3), ConstantInt.of(2),3),
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(DrunirMod.MODID, name));
    }
